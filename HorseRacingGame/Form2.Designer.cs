namespace HorseRacingGame
{
    partial class Form2
    {
        ...
        private void InitializeComponent()
        {
            ...
            label4.TabIndex = 2;
            label4.Text = "Kullanıcı 3";
            label4.Visible = false;
            // 
            // label5
            // 
            label5.AutoSize = true;
            label5.Location = new Point(64, 254);
            label5.Name = "label5";
            label5.Size = new Size(77, 20);
            label5.TabIndex = 2;
            label5.Text = "Kullanıcı 4";
            label5.Visible = false;
            // 
            // label6
            // 
            label6.AutoSize = true;
            label6.Location = new Point(64, 298);
            label6.Name = "label6";
            label6.Size = new Size(77, 20);
            label6.TabIndex = 2;
            label6.Text = "Kullanıcı 5";
